...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-brand-dark-900 via-brand-dark-800 to-brand-dark-900 border-b border-brand-gold/15 py-16 lg:py-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-right">
            {/* Top Flame Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-red/30 border border-brand-red-bright/40 text-brand-gold text-xs font-bold shadow-md">
              <Flame className="w-4 h-4 text-brand-gold animate-bounce" />
              <span>كباب سعيد البرنس — الخلطة والتتبيلة الأصلية</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-brand-cream leading-tight">
              كبابجي البرنس
            ...
            {/* Subheadline */}
            <p className="text-base sm:text-lg text-brand-cream-muted leading-relaxed max-w-2xl font-medium">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <div className="flex items-center gap-2 bg-brand-dark-700/60 border border-brand-gold/20 px-3 py-1.5 rounded-lg text-xs font-semibold">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md aspect-square rounded-3xl glass-panel p-4 border border-brand-gold/30 shadow-2xl overflow-hidden group">
              {/* Image Frame */}
              <div className="w-full h-full rounded-2xl overflow-hidden relative">
                ...
                {/* Floating Dish Badge */}
                <div className="absolute bottom-4 right-4 left-4 glass-panel p-3 rounded-xl border border-brand-gold/30 flex items-center justify-between">
                  <div className="text-right">
                    <span className="text-xs text-brand-gold font-extrabold block">الأكثر طلباً 👑</span>
                    <span className="text-sm font-bold text-brand-cream">كباب ضاني وسجق بلدي</span>
                  </div>
